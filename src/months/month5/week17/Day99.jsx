...
const QUESTIONS = [
  {
    ...
    w: {
      ...
      1: 'Tech stack selection is Step 3 or 4. Picking it first shows you\'re solution-first, not problem-first.',
      2: 'Storage math is important but it belongs in Step 2 (scope), after you know what you\'re designing.',
    },
  ...
  },
  {
    ...
    o: ['Step 1 — Clarify Requirements', 'Step 3 — High-Level Design', 'Step 2 — Define Scope', 'Step 4 — Deep Dive'],
    a: 2,
    ...
    w: {
      ...
      1: 'Step 3 is drawing boxes. You need scope defined first so you know which services to draw.',
  ...
  },
  {
    ...
    o: ['1,157', '10,000', '100', '100,000'],
    a: 0,
    e: '100M × 10 = 1B requests/day. 1B / 86,400 seconds ≈ 11,574 QPS ≈ 1,157 after rounding. Peak is typically 2–3× average.',
    w: {
      1: '10,000 forgets to divide by seconds in a day (86,400). You can\'t just divide by DAU.',
      2: '100 is way too low. You divided by 1M instead of seconds in a day.',
  ...
  },
  {
    ...
    o: ['Step 3 — High-Level Design', 'Step 4 — Deep Dive', 'Step 2 — Define Scope', 'Step 5 — Scale'],
    a: 1,
    ...
    w: {
      0: 'Step 3 is drawing the overall architecture. It\'s intentionally high-level — not a trade-off discussion.',
      2: 'Step 2 is defining what you will and won\'t design. It\'s about scope, not depth.',
  ...
  },
  {
    ...
    w: {
      1: 'Cache eviction policy is a Step 5 (scale) concern, not the core algorithmic trade-off for celebrity timelines.',
      2: 'Sharding key is a Step 5 concern. The celebrity hot-spot problem is specifically about fan-out strategy.',
      3: 'SQL vs NoSQL is a Step 3 choice. The celebrity problem is about write amplification, not data model.',
    },
    r: { id: 's5', label: 'Section 5 — Step 4: Deep Dive' },
  },
  {
    q: 'You\'re in Step 5. Your DB can handle 5,000 QPS but you need 50,000 QPS reads. What\'s the first thing you add?',
    o: ['Switch from SQL to NoSQL', 'Add a Redis cache to absorb reads', 'Shard the database into 10 shards', 'Add 10 read replicas'],
    a: 1,
    ...
    w: {
      0: 'Switching databases is a massive migration for a problem that a cache can often solve. NoSQL doesn\'t automatically make you faster.',
      2: 'Sharding is expensive and complex. Try cache first — sharding is the last resort for write scaling, not read scaling.',
      3: 'Read replicas help but each replica still runs every query. Cache absorbs 80–95% of reads before they hit any DB.',
    },
  ...
  },
  {
    ...
    w: {
      0: 'Logging + user alert is the fallback of last resort. A good system retries safely using idempotency before bothering the user.',
      1: 'ACID applies within one DB. Cross-service transactions (checkout → payment service) are NOT covered by ACID. This is the distributed transactions problem.',
      3: 'A circuit breaker prevents the call from being made — it doesn\'t handle the case where the call was in flight when the crash happened.',
    },
  ...
  },
  {
    ...
    o: ['Kafka transaction', 'Two-phase commit (2PC)', 'Saga pattern', 'Outbox pattern'],
    a: 3,
    ...
    w: {
      0: 'Kafka transactions exist but couple your app to Kafka\'s transactional producer, require idempotent producers, and are complex to configure correctly.',
      1: '2PC works but requires a distributed coordinator (XA) and blocks all participants until they vote. It\'s slow and fragile — avoided in modern systems.',
