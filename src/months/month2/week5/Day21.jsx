...
const QUESTIONS = [
  { q: 'The Singleton pattern guarantees…',
    ...
    w: { 0: 'Method count is irrelevant to the pattern.',
         2: 'Untestability is a CRITICISM of it, not its definition. 🙂',
         3: 'File organization has nothing to do with it.' },
  ...
  { q: 'Which Day-1 trick is the load-bearing wall of every singleton?',
    ...
    w: { 0: 'Static blocks initialize; they don\'t restrict creation.',
         2: 'Overloading multiplies doors — the opposite move.',
         3: 'this is bookkeeping, not access control.' },
  ...
  { q: 'Why does the unsynchronized lazy getInstance() create two instances under load?',
    ...
    w: { 0: 'The JVM behaves exactly as specified — the CODE made an unwarranted atomicity assumption.',
         2: 'GC never duplicates objects.',
         3: 'Visibility doesn\'t affect interleaving.' },
  ...
  { q: 'In double-checked locking, what is the volatile keyword for?',
    ...
    w: { 0: 'volatile actually costs a little speed — it BUYS correctness.',
         2: 'Visibility modifiers are unrelated to memory ordering.',
         3: 'Nothing in concurrency code is decorative.' },
  ...
  { q: 'Why is the static holder idiom considered the sweet spot for lazy singletons?',
    ...
    w: { 0: 'Memory footprint is identical.',
         2: 'It allows exactly one — via class-init guarantees.',
         3: 'It uses static heavily — just cleverly nested.' },
  ...
  { q: 'Why does Effective Java call the single-element ENUM the best singleton?',
    ...
    w: { 0: 'Enum constant access is no faster.',
  ...
  { q: 'The MAIN design criticism of Singleton is…',
    ...
    w: { 0: 'Singleton access is fast — speed is never the complaint.',
         2: 'One instance typically SAVES memory.',
         3: 'It absolutely can be thread-safe — that part is solved.' },
  ...
  { q: 'The modern alternative for "I need exactly one of this service" is…',
    ...
    w: { 0: 'All-static loses interfaces, laziness and substitutability.',
         2: 'Global variables are the disease itself.',
         3: 'Cloning multiplies instances — opposite goal.' },
