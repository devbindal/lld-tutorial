...
const QUESTIONS = [
  { q: 'The Prototype pattern\'s intent is…',
    ...
    w: { 0: 'Abstractness is unrelated.',
         2: 'Copying is the MECHANISM, not the forbidden thing.',
  ...
  { q: 'Prototype shines when…',
    ...
    w: { 0: 'Two-field objects are new\'s home turf.',
         2: '"Exactly one" is Singleton — Prototype makes MANY.',
         3: 'Immutables need no copying at all — share them (the day\'s deepest idea).' },
  ...
  { q: 'A SHALLOW copy of an object with a List field copies…',
    ...
    w: { 0: 'Copying contents too is DEEP copy — the upgrade, not the default.',
         2: 'Something is copied — primitives by value, references by address.',
         3: 'Everything copies — just at different depths than you hoped.' },
  ...
  { q: 'A DEEP copy fixes that by…',
    ...
    w: { 0: 'Locking is concurrency machinery — copying is the fix here.',
         2: 'static would SHARE state — backwards.',
         3: '== vs equals is comparison, not copying.' },
  ...
  { q: 'Why do Java experts (Effective Java) say AVOID Cloneable/clone()?',
    ...
    w: { 0: 'Speed is fine — design is the problem.',
         2: 'Arrays clone happily (shallow!) — and so can any class.',
         3: 'Still present in every Java version — just discouraged.' },
  ...
  { q: 'The recommended Java way to implement Prototype is…',
    ...
    w: { 0: 'Cloneable is exactly what Effective Java tells you to avoid.',
         2: 'Serialization round-trips are slow, restrictive last resorts.',
         3: 'Reflection-copying is fragile framework territory.' },
  ...
  { q: 'Why do IMMUTABLE objects make the whole copying question vanish?',
    ...
    w: { 0: 'Objects never copy themselves spontaneously.',
         2: 'Field count is irrelevant.',
         3: 'The JVM clones nothing automatically.' },
  ...
  { q: 'A prototype REGISTRY is…',
    ...
    w: { 0: 'The JVM\'s class list is reflection territory.',
         2: 'It\'s in-memory design, not persistence.',
         3: 'The registry itself MAY be a singleton — but that\'s incidental.' },
