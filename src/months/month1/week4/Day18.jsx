...
const QUESTIONS = [
  { q: 'The Law of Demeter says a method may talk only to…',
    ...
    w: { 0: 'Statics are usually counted as allowed too — but they\'re not the defining list.',
         2: 'Packages are irrelevant to LoD.',
         3: 'Parents are fine (this covers inherited members) — strangers come from getters.' },
  ...
  { q: 'Why is order.getCustomer().getAddress().getCity() expensive, precisely?',
    ...
    w: { 0: 'Three calls cost nanoseconds — speed is the wrong lens entirely.',
  ...
  { q: 'Is new StringBuilder().append("a").append("b").toString() a Demeter violation?',
    ...
    w: { 0: 'Dot-counting flags this falsely — every append returns the SAME object.',
         2: 'No helper wrapper needed for legitimate fluent chains.',
         3: 'Java version is irrelevant.' },
  ...
  { q: '"Tell, Don\'t Ask" means…',
    ...
    w: { 0: 'Getters aren\'t banned — outsourcing DECISIONS through them is.',
         2: 'Return types are unrelated.',
         3: 'It\'s about objects, not user prompts. 🙂' },
  ...
  { q: 'Your unit test needs: a mock Order returning a mock Customer returning a mock Address. This signals…',
    ...
    w: { 0: 'Mock depth is pain, not thoroughness — tests should mirror needs, not internal geography.',
         2: 'JUnit/Mockito work fine — the code under test is the patient.',
         3: 'MORE mocks is the disease, not the cure.' },
  ...
  { q: 'The two standard fixes for a train wreck are…',
    ...
    w: { 0: 'Try/catch handles failures — it cannot remove structural knowledge.',
         2: 'Public fields make digging EASIER — pure regression.',
         3: 'Static imports are syntax sugar, not structure medicine.' },
  ...
  { q: 'What is the "delegation tax" trap?',
    ...
    w: { 0: 'Delegation is a design move, not a performance one.',
         2: 'Java charges nothing. 🙂',
         3: 'Compilers love forwarders; READERS drown in them.' },
  ...
  { q: 'In Day 17\'s language, the Law of Demeter is…',
    ...
    w: { 0: 'Cohesion is about insides of one box; LoD polices the ropes between boxes.',
         2: 'It\'s a structural law, not naming.',
         3: 'Performance never enters the picture.' },
