...
const QUESTIONS = [
  { q: 'DRY, properly stated, says every piece of ______ must have exactly one authoritative home.',
    ...
    w: { 0: '"Code" is the common misquote — and it leads to merging lookalikes that should stay apart.',
         2: 'Classes are containers; knowledge is the unit.',
         3: 'Comments aren\'t the unit either (though duplicated knowledge IN comments also drifts!).' },
  ...
  { q: 'Why is copy-pasted business logic dangerous?',
    ...
    w: { 0: 'Disk space is free; drift is expensive.',
         2: 'No compiler warning exists for semantic duplication.',
         3: 'Speed is identical — correctness over time is what decays.' },
  ...
  { q: 'Signup requires age ≥ 18 (contract law) and car rental requires age ≥ 18 (company policy). Merging them into one shared AgeCheck is…',
    ...
    w: { 0: 'DRY requires same KNOWLEDGE — these are two different rules in matching costumes.',
         2: 'KISS is about machinery; this is about ownership of facts.',
  ...
  { q: 'The "rule of three" for duplication says…',
    ...
    w: { 0: 'Function length rules are a different style debate.',
         2: 'Nothing gets deleted — the rule times EXTRACTION.',
         3: 'Interface counting belongs to Day 14, not here.' },
  ...
  { q: 'KISS\'s main argument against "clever" code is…',
    ...
    w: { 0: 'Clever code can be perfectly correct — its cost is human, not mechanical.',
         2: 'No syntax is forbidden; opacity is.',
         3: 'Short but cryptic loses to slightly longer but instant to read.' },
  ...
  { q: 'YAGNI says don\'t build the plugin system "we might need someday" because…',
    ...
    w: { 0: 'Plugin systems are great WHEN plugins exist — the timing is the sin.',
         2: 'DRY is unrelated; the engine duplicates nothing.',
         3: 'Java has plugin mechanisms galore — irrelevant.' },
  ...
  { q: 'Does YAGNI forbid Day 15\'s practice of putting interfaces at the database/email boundaries?',
    ...
    w: { 0: '"All abstraction is YAGNI" throws out testability with the bathwater.',
         2: 'Frameworks don\'t change the principle.',
         3: 'YAGNI applies everywhere — UI included.' },
  ...
  { q: 'The healthiest way to see DRY/KISS/YAGNI next to SOLID is…',
    ...
    w: { 0: 'Nothing is replaced — they coexist as force and counterforce.',
         2: 'They tension, not contradict — both sides are needed.',
