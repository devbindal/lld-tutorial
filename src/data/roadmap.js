    ...
    },
    {
      ...
      weeks: [
        ...
        },
        {
          ...
          recap: { slug: 'w14', sub: 'Advanced problems — Chess, Food Delivery, Amazon Locker, Pub-Sub', ready: true },
          days: [
            { id: 66, slug: 'day66', title: 'Chess', sub: 'Piece movement as strategies, board state, check/checkmate', ready: true },
            { id: 67, slug: 'day67', title: 'Food Delivery', sub: 'Orders, restaurants, delivery matching & tracking', ready: true },
            { id: 68, slug: 'day68', title: 'Amazon Locker', sub: 'Locker assignment, sizes, pickup codes, expiry', ready: true },
            { id: 69, slug: 'day69', title: 'Pub-Sub Message Queue', sub: 'Topics, subscribers, delivery & offsets', ready: true },
            { id: 70, slug: 'day70', title: 'Week 14 Machine-Coding Drill', sub: 'Timed practice + review checklist', ready: true },
          ],
        },
        {
          id: 'w15',
          label: 'Week 15 · Machine Coding (Timed)',
          recap: { slug: 'w15', sub: 'Machine coding practice — Hotel Booking, Auction, Social Feed, Task Board', ready: true },
          days: [
            { id: 71, slug: 'day71', title: 'Hotel Booking', sub: 'Room types, date-range availability, atomic booking, pricing', ready: true },
            { id: 72, slug: 'day72', title: 'Online Auction', sub: 'Bidding, reserve price, snipe prevention, winner determination', ready: true },
            { id: 73, slug: 'day73', title: 'Social Media Feed', sub: 'Follow graph, fan-out vs pull-on-read, cursor pagination', ready: true },
            { id: 74, slug: 'day74', title: 'Task Management Board', sub: 'Boards, columns, tasks, movement history, assignments', ready: true },
            { id: 75, slug: 'day75', title: 'Week 15 Machine-Coding Drill', sub: 'Timed practice + Week 15 review', ready: true },
          ],
        },
        {
          id: 'w16',
          label: 'Week 16 · Mocks + Revision + Buffer',
          recap: { slug: 'w16', sub: 'Full course recap — 80 days of LLD mastery', ready: true },
          days: [
            { id: 76, slug: 'day76', title: 'Mock Interview Round 1', sub: 'Full 45-min problem — Online Exam System', ready: true },
            { id: 77, slug: 'day77', title: 'Mock Interview Round 2', sub: 'Full 45-min problem — Digital Library', ready: true },
            { id: 78, slug: 'day78', title: 'Full Course Recap', sub: 'The 80-day LLD journey — all patterns, all shapes', ready: true },
            { id: 79, slug: 'day79', title: 'The Interview Day', sub: 'Protocol, mindset, drawing tips, time management', ready: true },
            { id: 80, slug: 'day80', title: 'Graduation', sub: 'What to build next — your LLD roadmap beyond the course', ready: true },
          ],
        },
      ],
    },
      ...
      weeks: [
        {
          ...
          days: [
            ...
            { id: 85, slug: 'day85', title: 'Consistent Hashing', sub: 'Virtual nodes, load distribution, minimal reshuffling on scale-out', ready: true },
            { id: 86, slug: 'day86', title: 'URL Shortener', sub: 'Hash generation, collision handling, redirect service, analytics', ready: true },
            { id: 87, slug: 'day87', title: 'Search Engine', sub: 'Inverted index, TF-IDF ranking, crawl pipeline, query processing', ready: true },
            ...
            { id: 90, slug: 'day90', title: 'Event-Driven Architecture', sub: 'Event sourcing, CQRS, saga pattern, compensating transactions', ready: false },
          ],
        },
      ],
    },
